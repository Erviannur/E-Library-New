...
function Dropify(element, options) {
    ...
    var defaults = {
        ...
        error: {
            'fileSize': 'Ukuran file terlalu besar (maksimum {{ value }}).',
            'minWidth': 'Lebar gambar terlalu kecil (minimal {{ value }}px).',
            'maxWidth': 'Lebar gambar terlalu besar (maksimum {{ value }}px).',
            'minHeight': 'Tinggi gambar terlalu kecil (minimal {{ value }}px).',
            'maxHeight': 'Tinggi gambar terlalu besar (maksimum {{ value }}px).',
            'imageFormat': 'Format gambar tidak diizinkan (hanya {{ value }}).',
            'fileExtension': 'File tidak diizinkan (hanya {{ value }}).'
        },
        tpl: {
